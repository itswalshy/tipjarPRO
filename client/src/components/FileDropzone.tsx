...
export default function FileDropzone() {
  ...
  const renderDropzoneContent = () => {
    switch (state) {
      case DropzoneState.DRAGGING:
        return (
          <>
            <div className="mb-3 sm:mb-4 h-12 w-12 sm:h-16 sm:w-16 text-[#93ec93] mx-auto animate-pulse">
      ...
      case DropzoneState.PROCESSING:
        return (
          <>
            <div className="mb-3 sm:mb-4 h-12 w-12 sm:h-16 sm:w-16 text-[#9fd6e9] mx-auto">
            ...
            <div className="w-36 sm:w-48 h-1.5 sm:h-2 bg-[#364949] rounded-full overflow-hidden mt-2">
      ...
      case DropzoneState.SUCCESS:
        return (
          <div className="animate-scaleIn">
            ...
            {fileName && (
              <div className="flex items-center justify-center bg-[#364949] rounded-full px-3 sm:px-4 py-1.5 sm:py-2 mx-auto max-w-max">
                <FileTextIcon className="h-3.5 w-3.5 sm:h-4 sm:w-4 text-[#ffeed6] mr-1.5 sm:mr-2" />
                <p className="text-xs sm:text-sm text-[#ffeed6] m-0 truncate max-w-[140px] sm:max-w-[180px]">{fileName}</p>
              </div>
            )}
          </div>
        );
      ...
      case DropzoneState.ERROR:
        return (
          <div className="animate-scaleIn">
            ...
            <div className="bg-[#364949] rounded-lg p-2.5 sm:p-3 mb-3 max-w-[240px] sm:max-w-[280px] mx-auto">
            ...
            <button 
              ...
              className="text-xs sm:text-sm font-medium text-[#364949] bg-[#93ec93] hover:bg-opacity-90 inline-flex h-8 sm:h-10 justify-center items-center whitespace-nowrap border-0 rounded-full px-4 sm:px-6 py-1.5 sm:py-2 transition-all duration-300 shadow-md hover:shadow-lg"
            >
        ...
        return (
          <div className="animate-fadeIn w-full">
            <div className="flex flex-col items-center">
              ...
              <p className="text-[#ffeed6] m-0 mb-4 sm:mb-6 text-sm sm:text-base font-medium">Upload Tip Distribution Report</p>
              <button
                className="btn btn-primary focus-ring group px-4 py-2 sm:px-6 sm:py-2.5 text-sm sm:text-base"
                onClick={(e) => {
                  e.stopPropagation();
                  fileInputRef.current?.click();
                }}
              >
                <UploadCloudIcon className="h-4 w-4 sm:h-5 sm:w-5 group-hover:scale-110 transition-transform duration-300" />
                <span className="ml-2">Choose File</span>
              </button>
              <p className="mt-3 sm:mt-4 text-xs sm:text-sm text-[#9fd6e9] opacity-75">
                or drag and drop your file here
              </p>
            </div>
            <div className="text-xs sm:text-sm text-[#9fd6e9] mt-3 sm:mt-4 opacity-70">
  ...
  return (
    <>
      <div
        className={`gradient-border mb-3 sm:mb-4 text-center rounded-xl p-4 sm:p-6 flex justify-center items-center min-h-[180px] sm:min-h-[220px] shadow-soft transition-all duration-300 group ${
        ...
        role="button"
        tabIndex={0}
        aria-label="Upload tip distribution report"
        onKeyDown={(e) => {
